...
public class TelaParImpar extends JFrame {
	...
	private void initComponents() {
		...
		Icon icon = new ImageIcon("C:\\git\\padroesDeProjeto\\mvc03\\imagens\\branco.png");
	...
	private JPanel criarUmaMao(JPanel umaMao, CardLayout cardLayout) {
		...
		for (int i=0; i<=5; i++) {
			Icon icon = new ImageIcon("C:\\git\\padroesDeProjeto\\mvc03\\imagens\\" + i + ".png");
			JLabel jl = new JLabel(icon);
